CLASS LHC_ZR_1693FLIGHT DEFINITION INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
...
CLASS LHC_ZR_1693FLIGHT IMPLEMENTATION.
  ...
  METHOD validatePrice.
    ...
    READ ENTITIES OF ZR_1693Flight IN LOCAL MODE
  ENTITY Flight
    FIELDS ( Price )
