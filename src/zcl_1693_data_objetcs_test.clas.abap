CLASS zcl_1693_data_objetcs_test DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_1693_DATA_OBJETCS_TEST IMPLEMENTATION.
...
* Variable based on local type
    DATA my_variable TYPE my_type value 221.
...
* Variable based on global type .
    ...
    DATA airport TYPE /dmo/airport_id VALUE 'USA'.
...
**********************************************************************
    ...
    "Uncomment this line to see syntax error ( VALUE is mandatory)
     constants c_text2   type string value 'arthur'.
