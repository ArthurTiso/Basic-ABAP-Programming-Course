CLASS zcl_1693_arithmetic_cal DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_1693_ARITHMETIC_CAL IMPLEMENTATION.
...
**********************************************************************
    ...
    DATA the_date  TYPE d  VALUE '20260809'.
...
*    DATA(text) = |Total: { amount1 } EUR|.
*    DATA(text) = |Total: { amount + amount2 } EUR|.
...
*    DATA(text) = part1 && | | && part2.
    DATA(text) = |{ amount } + { amount2 }| &&  | = | && |{ amount + amount2 }|.
